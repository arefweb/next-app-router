...
## Introduction
Here you will find technical explanations for setting up 
some of the challenging parts of the app.
...
Then you have to set up the browser worker, you can see how it is done in `./mock/browser.ts`
...
Alternatively you can run the dev server by cd to `./server` then run `yarn dev` there as well.
